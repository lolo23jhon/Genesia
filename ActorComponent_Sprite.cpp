...
////////////////////////////////////////////////////////////
ActorComponent_Sprite::ActorComponent_Sprite(SharedContext& t_context, const std::string& t_texture, const sf::IntRect& t_spriteRect) :
	ActorComponent_Drawable(), m_texture{ t_texture }, m_textureRect{ t_spriteRect }
{
	Resource* resource{ t_context.m_resourceHolder->getResource(ResourceType::Texture, m_texture) };
...
////////////////////////////////////////////////////////////
ActorComponent_Sprite::ActorComponent_Sprite(SharedContext& t_context, std::stringstream& t_stream) : m_texture{ "" }, m_textureRect{} {
...
ActorComponentPtr ActorComponent_Sprite::clone(SharedContext& t_context)const {
	return std::make_unique<ActorComponent_Sprite>(t_context, m_texture, m_textureRect);
}
